...
def load_data_split(
    ...
    for train_index, test_index in strat_split.split(x, y):
        ...
        test_idx = test_index
        if save_all:
            save_test_indices = (Path(os.environ["STYLE_MODEL_DATA"]) /
                model_name / "indices")
...
def model_analysis(
    ...
    if save_all:
        save_plot = (Path(os.environ["STYLE_MODEL_DATA"])
            / model_name / "history.png")
        save_df = (Path(os.environ["STYLE_MODEL_DATA"])
